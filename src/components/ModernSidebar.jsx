  ...
  const menuSections = [
    {
      ...
      hoverColor: 'hover:bg-blue-100/70 dark:hover:bg-blue-900/25',
      items: [
        {
          path: '/dashboard',
          label: 'Dashboard',
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-green-100/70 dark:hover:bg-green-900/25',
      items: [
        {
          path: '/profile',
          label: 'Profile',
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-purple-100/70 dark:hover:bg-purple-900/25',
      items: [
        {
          path: '/skill-analyzer',
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-orange-100/70 dark:hover:bg-orange-900/25',
      items: [
        {
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-red-100/70 dark:hover:bg-red-900/25',
      items: [
        {
          path: '/job-search',
          label: 'Job Search',
    ...
    },
    {
      ...
      hoverColor: 'hover:bg-pink-100/70 dark:hover:bg-pink-900/25',
      items: [
        {
          path: '/ai-assistant',
      ...
      <NavLink
        ...
        className={`group flex items-center ${isSubItem ? 'pl-4' : 'pl-3'} pr-3 py-2.5 rounded-lg transition-all duration-200 ${
          isActive
            ...
            : `bg-white/70 border border-gray-200/70 text-gray-950 shadow-sm hover:shadow-md dark:bg-slate-900/30 dark:border-slate-700/40 dark:text-slate-100 ${hoverColor} transform -translate-x-1 hover:translate-x-0`
